...
class Hotel:
    ...
    def __init__(self,root):
        ...
        RightFrame1 = Frame(RightFrame, bd=5, width=800,height=50, padx=3,pady=0, relief=RIDGE)
        ...
        DateOut.set(time.strftime("%d/%m/%Y")) # date
        ...
        def addData():
            if(len(CusID.get())!=0):
                GuesthouseDatabase.addHotelRec(CusID.get(), Firstname.get(),  Surname.get(),Address.get(),Gender.get(),Mobile.get(),
                                     Nationality.get(),ProveOfID.get(),DateIn.get(),DateOut.get())
        ...
        def DisplayData():
            lstHotel.delete(0,END)
            for row in GuesthouseDatabase.viewData():
                lstHotel.insert(END,row,str(""))

        
        def HotelRec(event):
            global sd
            searchStd = lstHotel.curselection()[0]
            sd = lstHotel.get(searchStd )

            self.txtCusID.delete(0,END)
            self.txtCusID.insert(END,sd[1])
            ...
            self.cboGender.insert(END,sd[5])
            self.txtMobile.delete(0,END)
            self.txtMobile.insert(END,sd[6])            
            self.cboNationality.delete(0,END)
            self.cboNationality.insert(END,sd[7])
            self.cboProveOfID.delete(0,END)
            self.cboProveOfID.insert(END,sd[8]) 
            self.txtDateIn.delete(0,END)
            self.txtDateIn.insert(END,sd[9]) 
            self.txtDateOut.delete(0,END)
            self.txtDateOut.insert(END,sd[10]) 
        ...
        def DeleteData():
            if(len(CusID.get())!=0):
                GuesthouseDatabase.deleteRec(sd[0])
                Reset()
                DisplayData()

        def searchDatabase():
            lstHotel.delete(0,END)
            for row in GuesthouseDatabase.searchData(CusID.get(),Firstname.get(),Surname.get(),Address.get(),Gender.get(),Mobile.get(),
                                      Nationality.get(),ProveOfID.get(),DateIn.get(),DateOut.get()):
                lstHotel.insert(END,row,str(""))
        ...
        def update():
            if(len(CusID.get())!=0):
                GuesthouseDatabase.deleteRec(sd[0])
            if(len(CusID.get())!=0):                
                GuesthouseDatabase.addStdRec(CusID.get(),Firstname.get(),Surname.get(),Address.get(),Gender.get(),Mobile.get(),
                                      Nationality.get(),ProveOfID.get(),DateIn.get(),DateOut.get())           
                lstHotel.delete(0,END)            
                lstHotel.insert(END,(CusID.get(),Firstname.get(),Surname.get(),Address.get(),Gender.get(),Mobile.get(),
                                      Nationality.get(),ProveOfID.get(),DateIn.get(),DateOut.get()))
        ...
        self.lblProveOfID .grid(row=9, column=0,sticky=W)
        ...
        self.cboProveOfID.grid(row=9,column=1,pady=3,padx=2)
        ...
        text="Customer Ref\tFirstname\tSurname\tAddress\t\tGender\t\tMobile\tNationality\tProveOfID\tDateIn\tDateOut")
        ...
        lstHotel.grid(row=0, column=0, padx=7)
